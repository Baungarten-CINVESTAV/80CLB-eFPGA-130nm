...
SWB_y_offset = 15  #offset on um to separete CLB and SWB
  ...
  for Tile_position_x in range(FPGA_x_Size):
    ...
    #Print IOB_right
      ...
      # current_coordinate = offset_per_block(block_coordinates,Pointer_current_Tile_x,Pointer_current_Tile_y)
        ...
        print(Output_strign, file=file)
        Output_strign = f"{Str_Name_CBY}_0__{Tile_position_y}_ {SWB_0__Cordinate_number[0]+10} {current_coordinate[3]} N" ##Print the cby x 0
        print(Output_strign, file=file)
      ...
      if Tile_position_x != FPGA_x_Size-1:
        ...
        Output_strign = f"{Str_Name_IO_Bot}_{Tile_position_x}__0_ {(current_coordinate[4]+Space_CBX_SWB)} {SWB_0__Cordinate_number[1]+IO_B_y-138} N" ##Print the cbx 0 x
        print(Output_strign, file=file)
    ...
    ####################### Printvalues on a placement file  ###########################
     if (Tile_position_y!= (FPGA_y_Size-1)) & (Tile_position_x!= (FPGA_x_Size-1)):
      ...
      print(Output_strign, file=file)
      #Print CBY
      Output_strign = f"{Str_Name_CBY}_{Tile_position_x}__{Tile_position_y}_ {current_coordinate[2]+10} {current_coordinate[3]} N"
      print(Output_strign, file=file)
      #Print CBX
