...
if __name__ == "__main__":
    P_Block = 2  # Add the numbers of IO/block per perimeter
    Num_io_per_block = 4  # Add the number of input/output per block

    orientations = ["TOP", "RIGHT", "BOTTOM", "LEFT"]
    output_file = "180nm/pinmap_k4_N4_tileable_40nm.csv"
