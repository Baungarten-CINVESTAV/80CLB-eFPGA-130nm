...
# Wed Mar 13 19:21:37 2024
###############################################################################
current_design grid_io_bottom_out
###############################################################################
# Timing Constraints
###############################################################################
...
set_output_delay 5.0000 -clock [get_clocks {prog_clk}] -add_delay [get_ports {gfpga_pad_GPIO_PAD}]
...
set_load -pin_load 0.0334 [get_ports {gfpga_pad_GPIO_PAD}]
